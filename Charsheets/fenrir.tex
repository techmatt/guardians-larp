...
% ... or maybe they dispersed right away
% Include an anecdote about a personal slave.
...
\TODO{Mention Anubis}
%There's one other Celestial you get along with, \cAnubis{}.
%The other Celestial you can stand is an Egyptian, Anubis.
% you think he'd be okay knowing your real goals.
...
% Worrisome:
%You've already lost [whatever the valkyrie stole], but since they haven't cracked down on you yet, you're pretty sure it isn't in the Guardians' hands.
% Knows about the atomic bomb, but only because \cVal{} took his item.
A few months ago, one of your [...]
% Undoth widgets
disappeared. Not something you need to construct the radio, fortunately, but you're scared that it will fall into the hands of one of the AI or \cJascha{}, who would recognize its Undoth origin. % (from the Kisrin: they'll notice if the Undoth widget is used)
% can't be AI, they would notice immediately
...
% * Convince the Norse to kill the AIs/disable the Complex.
