...
\NEW{Abil}{\aExamine}{
  \s\MYname	{Examine Attributes}
  \s\MYtext	{You may examine another character's stat card, but only with their consent. You may not discuss the absolute numeric values directly, but you are free to make relative comparisons between characters.}
  \s\MYeffect	{I am arbitrating the games. You may show me your stat card, but you may also refuse to be examined.}
  }
