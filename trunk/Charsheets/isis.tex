...
\TODO{Cross reference the below with Hel's sheet}
...
% TODO: double check if this reference to Geb fits with the rest of the sheet.
...
% At the last games, Osiris lost his powers.
...
% Note that Anubis needs to get the scales back.
